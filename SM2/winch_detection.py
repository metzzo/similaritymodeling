...
X, Y, y_, train_features, train_labels, test_features, test_labels = load_winch_detection_model()
...
with tf.Session() as sess:
    ...
    save_path = saver.save(sess, os.path.abspath('.') + "/winch_model/winch_detection_model.tf")
